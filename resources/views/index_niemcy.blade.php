...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Eletrkon Bau- und Elektrizitätsunternehmen, Informationen über die Unternehmensgeschichte, Kontakt und durchgeführte Arbeiten" />
        <meta name="keywords" content="Elektriker, Elektrizität, Elektronikfirma, Baugesellschaft, Deutschland, Ojców, Wola Kalinowska, Berlin"/>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#services">Was wir tun</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">Unsere Projekte</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">über das Unternehmen</a></li>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase czym-sie-zajmujemy">Was wir tun</h2>
                    <br>
                    <br>
                ...
                <div class="row text-center">
                    <div class="col-md-4 zajecia">
                        ...
                        <h4 class="my-3">Elektroinstallationen</h4>
                        <p class="text-muted">Montage, Austausch, Modernisierung, Reparatur, Messungen, Sicherungskästen und Platinen,
                            Installation von Kabelwegen, Anbringen von Schränken, Geräten und Maschinen, Sanierung von elektrischen Schalttafeln, Installation von Beleuchtung</p>
                    </div>
                    <div class="col-md-4 zajecia2">
                        ...
                        <h4 class="my-3">Alarm-, Gegensprech- und Brandschutzanlagen </h4>
                        <p class="text-muted">Installation neuer Alarmsysteme, Installation eines Brandschutzsystems auf der Grundlage der bereitgestellten Konstruktion, Montage und Reparatur von Gegensprechanlagen </p>
                    </div>
                    <div class="col-md-4 zajecia3">
                        ...
                        <h4 class="my-3">Elektrische Messungen</h4>
                        <p class="text-muted">Isolationswiderstand, Erdung, Wirksamkeit des Brandschutzes, Durchgang und Lage der Kabel, Tests und Messungen von Elektroinstallationen in Ein- und Mehrfamilienhäusern sowie öffentlichen Versorgungsgebäuden </p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container nasze-prace">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Unsere Projekte</h2>
                ...
                <div class="row">
                    <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger center-route" href="{{'niemcy/realizacje'}}">Überprüfen Sie alle Projekte</a>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase o-elektronie">Über Elektron</h2>
                    <br>
                ...
                <ul class="timeline">
                    <li class="time-line">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Januar 2005</h4>
                                <h4 class="subheading">Gründung des Unternehmens</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Wir haben unsere Tätigkeit im Jahr 2005 aufgenommen </p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted time-line-2">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>März 2008</h4>
                                <h4 class="subheading">Erster großer Auftrag</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Zu diesem Zeitpunkt erhielten wir den ersten Großauftrag für den umfassenden Service der Halle in Krakau</p></div>
                        </div>
                    </li>
                    <li class="time-line-3">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>2019</h4>
                                <h4 class="subheading">Noch ein Befehl</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Das Unternehmen hat sich ständig weiterentwickelt und wir haben viel in Deutschland und Polen gearbeitet</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted time-line-4">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                ...
                                <h4 class="subheading">Wir warten auf eine Bestellung von Ihnen !!</h4>
                            </div>
                        </div>
                    </li>
                ...
                <hr>
                  <div class="row">
                    <div class="col-sm-8">
                        ...
                        <h3>Kontaktdetails  - Elektron Marcin Marszałek</h3>
                        <hr  width="80%">
                        <h4 class="pt-2">Büro</h4>
                        <i class="fas fa-globe" style="color:#000"></i>Wola Kalinowska ul. Ojcowska 25, 32-045 Sułoszowa <br>
                        <h4 class="pt-2">Telefon</h4>
                        <i class="fas fa-phone" style="color:#000"></i> <a href="tel:+"> +49 151-661-510-02 <br> +49 151-755-089-88 <br> +48 668-445-448</a><br>
