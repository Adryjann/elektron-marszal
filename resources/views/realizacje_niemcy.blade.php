...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Elektrische Arbeiten von Elektron" />
        <meta name="keywords" content="Elektriker, Elektrizität, Elektronikfirma, Baugesellschaft, Deutschland, Ojców, Wola Kalinowska"/>
        <meta name="author" content="Adrian Bugaj" />
        <meta name="robots" content="follow"/>
        <title>Projekte - Elektron</title>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{"/elektron"}}"><img src="{{asset('css/images/2.png')}}" class="flaga"/></a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{"/"}}"><img src="{{asset('css/images/3.png')}}" class="flaga"/></a></li>
        ...
        <header class="masthead realization">
            <div class="container">
                <div class="masthead-heading text-uppercase">Unsere Projekte</div>
